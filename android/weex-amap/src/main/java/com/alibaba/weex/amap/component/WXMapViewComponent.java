...
//  }
  ...
  @WXComponentProp(name = Constant.Name.MAPSTYLE)
  public void setMapStyle(String mapStyle){
//    String[] absolutePath = getContext().getAssets().list("");
//    File file =
    String fileName = "file:///android_asset/" + mapStyle;
    mAMap.setCustomMapStylePath(fileName);
  }
...
//      mAMap.setMyLocationType(AMap.LOCATION_TYPE_LOCATE);
  ...
  private static class InfoWindowAdapter implements AMap.InfoWindowAdapter {
    ...
    private View render(Marker marker) {
      ...
      } else if (mWXMapViewComponent.mInfoWindowHashMap.containsKey(marker.getId())){
